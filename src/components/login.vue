          ...
          <div class="row no-gutters">
            ...
            <div class="col-md-7">
              <div class="card-body">
                ...
                <p class="login-card-footer-text"> ¿No tienes una cuenta? <a href="#" v-on:click="clickRegisterButton" class="text-reset">Regístrate</a>
                </p>
  ...
  export default {
    ...
    methods: {
      ...
      async askLogintoBack(user, password) {
        ...
        axios.post("http://localhost:8081/auth/login", formBody, {
          headers: {
