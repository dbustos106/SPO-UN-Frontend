...
.ing {
  animation: change_color 0.7s forwards;
  color: #ffc107;
}
...
#footer .footer-top .footer-dir {
  margin-bottom: 5px;
}

#footer .footer-top .footer-dir h4 {
  font-size: 22px;
  margin: 0 0 10px 0;
  padding: 2px 0 2px 0;
  line-height: 1;
...
#footer .footer-top .footer-dir p {
  font-size: 14px;
  line-height: 24px;
  margin-bottom: 0;
