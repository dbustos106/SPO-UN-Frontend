    ...
    <div id="marcoLog" class="container">
      <div class="card login-card">
        <div class="row no-gutters">
          ...
          <!-- ======= Form ======= -->
          <div class="col">
            <p class="login-card-description mt-5">Iniciar sesión</p>
            <div class="form-group needs-validation">
              ...
              <div class="col-sm-8 mx-auto mb-5 mt-5">
  ...
  methods: {
    ...
    openUserComponent(role) {
      ...
      if (role == "Professor") {
        ...
        document.getElementById("professorUsername").innerHTML =
        ...
        document.getElementById("patientUsername").innerHTML =
          sessionStorage.Username;
      } else if (role == "Admin") {
