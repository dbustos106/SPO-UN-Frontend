<template>
  <div>
    ...
    <div class="input_label">
      <label for="namef" id="namePf">Nombre </label>
      <label for="namel" id="namelPR">Apellido </label><br />
      <input
        type="text"
        id="fnamePR"
        class="fname"
    ...
    <div class="input_label">
      ...
      <label for="pass2" id="confirPassLabelP">Confirmar Contraseña </label
      ><br /><br />
